          ...
          <div className="rounded-md shadow-sm -space-y-px">
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute cursor-pointer inset-y-0 right-0 w-10 flex items-center justify-center text-sm leading-5 hover:bg-gray-50 rounded-r-md transition-colors duration-150 z-20"
              >
                {showPassword ? (
